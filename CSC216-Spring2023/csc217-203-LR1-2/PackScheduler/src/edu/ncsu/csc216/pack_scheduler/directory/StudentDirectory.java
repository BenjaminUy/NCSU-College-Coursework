...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException if password or repeatPassword are null or empty strings
	 * @throws IllegalArgumentException if hashed password does not equal the repeated hashed password 
	 */
	 ...
	 * @throws IllegalArgumentException if the cryptographic algorithm is not provided when requested
	 */
