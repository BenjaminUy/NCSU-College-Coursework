...
public class CourseRecordIOTest {
	...
	private final String invalidTestFile = "test-files/empty.txt";
	...
	/**
	 * Tests readCourseRecords() for a valid test file
	 */
	@Test
	public void testReadCourseRecordsValid() {
		try {
	...
	/**
	 * Tests readCourseRecords() for an empty test file
	 */
	@Test
	public void testReadCourseRecordsEmpty() {
