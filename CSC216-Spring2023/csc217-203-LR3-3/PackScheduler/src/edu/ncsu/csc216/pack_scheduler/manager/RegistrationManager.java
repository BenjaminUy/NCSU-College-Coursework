...
public class RegistrationManager {
	...
	public boolean login(String id, String password) {
		...
		if (s == null && f == null && !registrar.getId().equals(id)) {	// If user is null and registrar.getId is not equal to id, throw IAE
	...
	/**
	 * Adds a faculty member to a course if the current user is the registrar.
	 * @param c the course to add to
	 * @param f the faculty member we shall add.
	 * @return true if the faculty member is added, false if not.
	 */
	...
	/**
	 * Removes a faculty member from a course if the current user is the registrar.
	 * @param c the course to add to
	 * @param f the faculty member we shall add
	 * @return true if the faculty member is removed, false if not
	 */
	...
	/**
	 * Resets a faculty members schedule. 
	 * @param f The faculty member's schedule which we shall reset.
	 */
