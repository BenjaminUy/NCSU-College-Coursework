...
//import edu.ncsu.csc216.pack_scheduler.io.StudentRecordIO; unused
...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		Exception e = assertThrows(IllegalArgumentException.class, () -> sd.loadStudentsFromFile("hello.txt"));
	...
	public void testAddStudent() {
		...
		Exception e1 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(LAST_NAME, FIRST_NAME, ID, EMAIL, PASSWORD, "", MAX_CREDITS));
		assertEquals("Invalid password", e1.getMessage());
		
		Exception e2 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(LAST_NAME, FIRST_NAME, ID, EMAIL, PASSWORD, "hello", MAX_CREDITS));
		assertEquals("Passwords do not match", e2.getMessage());
		
		Exception e3 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(LAST_NAME, FIRST_NAME, ID, EMAIL, PASSWORD, null, MAX_CREDITS));
		...
		assertTrue(sd.addStudent(FIRST_NAME, LAST_NAME, "1", EMAIL, PASSWORD, PASSWORD, 19));
		assertTrue(sd.addStudent(FIRST_NAME, LAST_NAME, "2", EMAIL, PASSWORD, PASSWORD, 0));
	}
	...
	/**
	 * Tests StudentDirectory.saveStudentDirectory when it cannot write to a given file. 
	 * Should fail locally, but pass on jenkins.
	 */
	@Test
	...
	/**
	 * tests getStudentByID method for a valid student id
	 */
	@Test
	public void testValidId() {
		...
		assertEquals(s, sd.getStudentById(a));
	}
	
	/**
	 * tests getStudentById method for an invalid student id
	 */
	@Test 
	public void testInvalidId() {
		StudentDirectory sd = new StudentDirectory();
		assertNull(sd.getStudentById("zKing"));
	}
}
