...
public class StudentDirectory {
	...
	/**
	 * Constructs the student directory by reading in student information from the given file.
	...
	/**
	 * Searches studentDirectory for a student with given ID
	 * @param ids id to search for Student by
	 * @return the Student with the ID, or null if Student does not exist
	 */
	public Student getStudentById(String ids) {
		for (int i = 0; i < studentDirectory.size(); i++) {
			if (ids.equals(studentDirectory.get(i).getId())) {
