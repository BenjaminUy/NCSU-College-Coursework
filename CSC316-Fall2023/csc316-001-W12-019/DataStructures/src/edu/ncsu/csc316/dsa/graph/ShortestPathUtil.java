...
public class ShortestPathUtil {
    ...
    public static <V, E extends Weighted> Map<Vertex<V>, Integer> dijkstra(Graph<V, E> graph, Vertex<V> start) {    	
    	...
    	Map<Vertex<V>, PriorityQueue.Entry<Integer, Vertex<V>>> pqEntries = new LinearProbingHashMap<>();
    	...
    	for (Vertex<V> v : graph.vertices()) {
    		...
    		PriorityQueue.Entry<Integer, Vertex<V>> apqEntry = q.insert(currentCost, v);
    		pqEntries.put(v, apqEntry);
    	}
    	while (!q.isEmpty()) {
