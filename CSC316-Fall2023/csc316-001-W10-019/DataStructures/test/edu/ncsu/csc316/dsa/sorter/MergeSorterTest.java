...
/**
 * This class tests the MergeSorter class
 * @author Benjamin Uy
 */
public class MergeSorterTest {
	...
	/**
	 * Method tests SelectionSort using the natural ordering of students in a reverse sorted array
	 */
	@Test
	public void testSortStudentNaturalReverse() {
		sorter = new MergeSorter<Student>();
