...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    /**
     * Returns if the map has no elements
     * @return true if size is zero, false if otherwise
     */
    @Override
    ...
    /**
     * Returns an Iterator that interacts with K objects
     * @return an Iterator that interacts with K objects
     */
    @Override
    ...
    /**
     * Returns an Iterator that interacts with V objects
     * @return an Iterator that interacts with V objects
     */
    @Override
