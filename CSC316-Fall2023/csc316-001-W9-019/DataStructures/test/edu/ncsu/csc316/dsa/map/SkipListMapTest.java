 ...
 * a sorted linked list that uses quad nodes
 *
 * @author Dr. King
 * @author Benjamin Uy
 */
public class SkipListMapTest {
    ...
    public void testStudentMap() {
    	studentMap = new SkipListMap<Student, Integer>(new StudentIDComparator());
        ...
        assertEquals("SkipListMap[" + s1.toString() + ", " + s2.toString() + ", " + s3.toString() + ", " + 
        ...
        assertFalse(studentMap.isEmpty());
        assertEquals("SkipListMap[" + s5.toString() + ", " + s3.toString() + ", " + s4.toString() + ", " + 
