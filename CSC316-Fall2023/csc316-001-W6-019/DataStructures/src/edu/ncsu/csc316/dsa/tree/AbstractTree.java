...
public abstract class AbstractTree<E> implements Tree<E> {
     ...
     * 
     * @param p the position for which to update the element stored at that position
     * @param value the new element that should replace the existing element in the provided position
     * @return the original element that was replaced by the new element at the provided position
    ...
    protected class PositionCollection implements Iterable<Position<E>> {
         ...
         * @return an iterator object that interacts with Positions storing generic elements
         */
