/**
    ...
    Implementation file containing the function for reading a line from a given file stream.
    This function will make it easier to read and process commands from the user a line at a time.
*/
